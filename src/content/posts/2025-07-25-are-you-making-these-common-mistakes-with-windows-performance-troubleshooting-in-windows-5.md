...
1\. Open Command Prompt as Administrator. 2. Type sfc /scannow and press Enter. 3. After completion, type chkdsk /f and follow the prompts (you may need to restart).
...
[Glary Utilities](https://www.glarysoft.com)’ Registry Cleaner can safely scan and remove invalid or orphaned registry entries. For example, after uninstalling a graphics driver, related invalid entries might remain, causing errors or slowdowns. Glary’s tool creates automatic backups, so you can restore changes if needed.
...
Use [Glary Utilities](https://www.glarysoft.com)’ Process Manager for a more detailed view, including descriptions and security ratings for running processes. This additional insight helps you identify unfamiliar or potentially harmful software that could be degrading performance.
